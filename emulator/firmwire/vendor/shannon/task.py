...
class SamsungRTaskLayout(TaskLayout):
    NAME = "samsung-r"
...
class SamsungATaskLayout(TaskLayout):
    NAME = "samsung-a"
...
class SamsungS53xxTaskLayout(TaskLayout):
    NAME = "samsung-s53xx"

    TASK_STRUCT_SIZE = 0x1a8

    TASK_STACKBASE_OFFSET = 0x10
    TASK_NAME_PTR_OFFSET = 0x4c
    TASK_SCHED_PRIO_OFFSET = 0x50
    TASK_STACKSIZE_OFFSET = 0x54
    TASK_MAIN_FN_OFFSET = 0x58
    TASK_PRE_FN_OFFSET = 0x5c

    SUBTASK_MAGIC_OFFSET = 0x8  #
    SUBTASK_NAME_OFFSET = 0x70
    SUBTASK_TASK_P_OFFSET = 0x140  #
    SUBTASK_NAME_SIZE = 0x20
...
TASK_LAYOUT_BY_NAME = OrderedDict(
    {
        SamsungRTaskLayout.NAME: SamsungRTaskLayout,
        SamsungATaskLayout.NAME: SamsungATaskLayout,
        SamsungS53xxTaskLayout.NAME: SamsungS53xxTaskLayout,
...
class Task:
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}<{self.name} ({self.main_fn:#010x})>"
