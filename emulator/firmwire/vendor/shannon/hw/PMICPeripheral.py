...
class PMIC2Peripheral(LoggingPeripheral):
    def hw_read(self, offset, size):
        if offset == 0x20:
            value = 1
            offset_name = "UNK_LOOP"
            ...
            return super(PMIC2Peripheral, self).hw_read(offset, size)
    ...
    def hw_write(self, offset, size, value):
        if offset == 0x20:
            ...
            return super(PMIC2Peripheral, self).hw_write(offset, size, value)
