...
class S5133AP(ShannonSOC):
    peripherals = [
        SOCPeripheral(PMIC2Peripheral, 0x8F910000, 0x1000, name="PMIC"), #
    ]
    ...
    SHM_BASE = 0x60000000
    SOC_BASE = 0x82020000
    SOC_CLK_BASE = 0x99600000
    CLK_PERIPHERAL = S5133APClkPeripheral #
